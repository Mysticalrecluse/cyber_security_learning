...
![image-20250219220647217](D:\git_repository\cyber_security_learning\markdown_img\image-20250219220647217.png)

**3090有10496个核心可以工作**

![image-20250219220729052](D:\git_repository\cyber_security_learning\markdown_img\image-20250219220729052.png)

**3080Ti有10240个核心可以工作**

![image-20250219220850861](D:\git_repository\cyber_security_learning\markdown_img\image-20250219220850861.png)

**3080有8704个核心可以工作**，这相当于有16个损坏且被禁用的流式多处理器。

![image-20250219220936119](D:\git_repository\cyber_security_learning\markdown_img\image-20250219220936119.png)

不同的显卡在最高频率和支持GPU的显存容量和代数也有所不同。

![image-20250219221158924](D:\git_repository\cyber_security_learning\markdown_img\image-20250219221158924.png)
...
![image-20250219222827202](D:\git_repository\cyber_security_learning\markdown_img\image-20250219222827202.png)
...
![image-20250219224524786](D:\git_repository\cyber_security_learning\markdown_img\image-20250219224524786.png)



#### 显卡内部的其他部分

![image-20250219224738984](D:\git_repository\cyber_security_learning\markdown_img\image-20250219224738984.png)

左侧是用于连接显示器的各种接口

![image-20250219224919218](D:\git_repository\cyber_security_learning\markdown_img\image-20250219224919218.png)

右上角是12V输入电源接口，

![image-20250219225019094](D:\git_repository\cyber_security_learning\markdown_img\image-20250219225019094.png)

下方是插入主板的PCIe引脚

![image-20250219225127640](D:\git_repository\cyber_security_learning\markdown_img\image-20250219225127640.png)

在PCB上，大部分较小的组件，即下图粉色部分，构成了电压调节模块，它**将输入的12V电压转换为1.1V**

![image-20250219225216253](D:\git_repository\cyber_security_learning\markdown_img\image-20250219225216253.png)

![image-20250219225338444](D:\git_repository\cyber_security_learning\markdown_img\image-20250219225338444.png)

这些电力会使GPU发热，因此显卡的大部分重量都来自于带有4根热管的散热器

![image-20250219230316233](D:\git_repository\cyber_security_learning\markdown_img\image-20250219230316233.png)

这些热管将热量从GPU和显存芯片传递到散热鳍片，在那里风扇会帮忙散热

![image-20250219230500836](D:\git_repository\cyber_security_learning\markdown_img\image-20250219230500836.png)

![image-20250219230601215](D:\git_repository\cyber_security_learning\markdown_img\image-20250219230601215.png)
...
![image-20250219230806224](D:\git_repository\cyber_security_learning\markdown_img\image-20250219230806224.png)
...
![image-20250219232349935](D:\git_repository\cyber_security_learning\markdown_img\image-20250219232349935.png)

相比之下，支持CPU的DRAM条只有64位总线宽度，最大带宽接近每秒64GB

![image-20250219232537298](D:\git_repository\cyber_security_learning\markdown_img\image-20250219232537298.png)
...
![image-20250219233138850](D:\git_repository\cyber_security_learning\markdown_img\image-20250219233138850.png)

上一代GDDR6X，也就是3090显卡中的显存，使用了一种不同的编码方案，称为PAM-4，它使用4种不同的电压等级发送2位数据，

![image-20250219233457136](D:\git_repository\cyber_security_learning\markdown_img\image-20250219233457136.png)
...
![image-20250219235354385](D:\git_repository\cyber_security_learning\markdown_img\image-20250219235354385.png)

例如：桌子上的牛仔帽大约由2.8万个三角形组成，这些三角形由大约1.4万个顶点连接而成，每个顶点有X,Y和Z坐标，

![image-20250219235443145](D:\git_repository\cyber_security_learning\markdown_img\image-20250219235443145.png)

![image-20250219235620970](D:\git_repository\cyber_security_learning\markdown_img\image-20250219235620970.png)

![image-20250219235655045](D:\git_repository\cyber_security_learning\markdown_img\image-20250219235655045.png)

这些顶点坐标是使用一个名为模型空间的坐标系构建的

![image-20250219235742595](D:\git_repository\cyber_security_learning\markdown_img\image-20250219235742595.png)

原点(0,0,0)位于帽子的中心，为了构建一个3D世界，我们会放置数百个物体，

![image-20250219235856980](D:\git_repository\cyber_security_learning\markdown_img\image-20250219235856980.png)

每个物体都有自己的模型空间，并放入世界环境中

![image-20250219235948648](D:\git_repository\cyber_security_learning\markdown_img\image-20250219235948648.png)

为了让摄像机能够判断每个物体相对于其他物体的位置，我们必须转换或变化每个独立模型空间中的所有顶点到共享的世界坐标系或世界空间中，

![image-20250220000139771](D:\git_repository\cyber_security_learning\markdown_img\image-20250220000139771.png)

举个例子，我们如何将牛仔帽的1.4万个顶点从模型空间转换到世界空间？

我们使用一个单一指令，将帽子原点在世界空间中的位置，添加到模型空间中单个顶点对应的X,Y,Z坐标上。

![image-20250220000453240](D:\git_repository\cyber_security_learning\markdown_img\image-20250220000453240.png)

接下来，我们将这个指令复制到多个数据上，也就是剩余的X，Y，Z坐标，这些坐标用于构建帽子的其他数千个顶点。

![image-20250220000425065](D:\git_repository\cyber_security_learning\markdown_img\image-20250220000425065.png)
...
![image-20250220152808493](D:\git_repository\cyber_security_learning\markdown_img\image-20250220152808493.png)

将这些值输入SHA-256哈希算法后，会输出一个随机的256位值。

![image-20250220153048569](D:\git_repository\cyber_security_learning\markdown_img\image-20250220153048569.png)

你可以把这个算法想象成一个彩票生成器，你无法选择彩票号码，但基于输入数据，SHA-256算法会生成一个随机的彩票号码。

![image-20250220153312514](D:\git_repository\cyber_security_learning\markdown_img\image-20250220153312514.png)

因此，如果你改变nonce值，而保持其他交易数据不变，你就会生成一个新的随机彩票号码。这场比特币挖矿彩票的赢家是第一个随机生成的，前80位全为零的彩票号码，而其余的176位则无关紧要

![image-20250220153519738](D:\git_repository\cyber_security_learning\markdown_img\image-20250220153519738.png)
...
![image-20250220153851305](D:\git_repository\cyber_security_learning\markdown_img\image-20250220153851305.png)
...
![image-20250220002110344](D:\git_repository\cyber_security_learning\markdown_img\image-20250220002110344.png)

而这个线程会匹配到一个CUDA核心。

![image-20250220002135050](D:\git_repository\cyber_security_learning\markdown_img\image-20250220002135050.png)

线程会被捆绑成32个一组，称为warp。

![image-20250220002209477](D:\git_repository\cyber_security_learning\markdown_img\image-20250220002209477.png)

同一系列指令会发送给一个Wrap中的所有线程。

![image-20250220002227808](D:\git_repository\cyber_security_learning\markdown_img\image-20250220002227808.png)

接下来，warp会被分组成线程块，由流式多处理器处理。

![image-20250220002258950](D:\git_repository\cyber_security_learning\markdown_img\image-20250220002258950.png)

最后，线程块会被分组称作网络，在整个GPU上继续计算。

![image-20250220002336438](D:\git_repository\cyber_security_learning\markdown_img\image-20250220002336438.png)

所有这些计算都由Gigathread引擎管理和调度，它可以高效地将线程块映射到可用的流式处理器上

![image-20250220002601721](D:\git_repository\cyber_security_learning\markdown_img\image-20250220002601721.png)
...
![image-20250220003550711](D:\git_repository\cyber_security_learning\markdown_img\image-20250220003550711.png)
...
![image-20250220143614508](D:\git_repository\cyber_security_learning\markdown_img\image-20250220143614508.png)
...
![image-20250220160056777](D:\git_repository\cyber_security_learning\markdown_img\image-20250220160056777.png)
...
![image-20250220160424430](D:\git_repository\cyber_security_learning\markdown_img\image-20250220160424430.png)
...
![image-20250220161126166](D:\git_repository\cyber_security_learning\markdown_img\image-20250220161126166.png)
...
![image-20250220162142591](D:\git_repository\cyber_security_learning\markdown_img\image-20250220162142591.png)
...
![image-20250220162618979](D:\git_repository\cyber_security_learning\markdown_img\image-20250220162618979.png)
...
![image-20250220165035258](D:\git_repository\cyber_security_learning\markdown_img\image-20250220165035258.png)
...
![image-20250220165519828](D:\git_repository\cyber_security_learning\markdown_img\image-20250220165519828.png)
...
![image-20250220170918027](D:\git_repository\cyber_security_learning\markdown_img\image-20250220170918027.png)

随着AI深度学习的发展，对GPU的算力需求不断提升，单机单卡算力已无法满足应用需求，单机2卡，单机4卡，单机8卡的GPU算力服务器应用而生，此时一个新的问题出现了：

如何让一台服务器中的多个GPU之间有效并快速地数据传输呢？

![image-20250220172131474](D:\git_repository\cyber_security_learning\markdown_img\image-20250220172131474.png)



#### 传统服务器：2卡GPU数据传输模式

![image-20250220172317979](D:\git_repository\cyber_security_learning\markdown_img\image-20250220172317979.png)
...
![image-20250220222601089](D:\git_repository\cyber_security_learning\markdown_img\image-20250220222601089.png)
...
![image-20250220222803405](D:\git_repository\cyber_security_learning\markdown_img\image-20250220222803405.png)
...
![image-20250220222942229](D:\git_repository\cyber_security_learning\markdown_img\image-20250220222942229.png)

于是2018年，NVIDIA公司发布“NVSwitch”技术架构，它是一种基于NVLink技术组网的交换芯片/设备，将GPU间的高速通讯利用NVSwitch，组成一个基于NVLink的互联拓扑结构

![image-20250220223211561](D:\git_repository\cyber_security_learning\markdown_img\image-20250220223211561.png)
...
![image-20250220223301261](D:\git_repository\cyber_security_learning\markdown_img\image-20250220223301261.png)

![image-20250220223714490](D:\git_repository\cyber_security_learning\markdown_img\image-20250220223714490.png)
...
![image-20250220224032352](D:\git_repository\cyber_security_learning\markdown_img\image-20250220224032352.png)

而在点对点的互联架构下，实现全联通，每个GPU需要7条NVLink通道

![image-20250220224139573](D:\git_repository\cyber_security_learning\markdown_img\image-20250220224139573.png)
...
![image-20250220224444201](D:\git_repository\cyber_security_learning\markdown_img\image-20250220224444201.png)

如果GPU的某条NVLink通道中断或者堵塞，它还可以通过其他3条NVLink通道进行通信，而在点对点互联架构下，任意GPU只有1条NVLink通道，如果某个NVLink通道中断或者堵塞，即会引起NVLink连接的GPU之间的通信故障

![image-20250220224737746](D:\git_repository\cyber_security_learning\markdown_img\image-20250220224737746.png)
...
![image-20250220225024716](D:\git_repository\cyber_security_learning\markdown_img\image-20250220225024716.png)
...
![image-20250220225458953](D:\git_repository\cyber_security_learning\markdown_img\image-20250220225458953.png)
...
随着AI深度学习的发展，对GPU的算力需求不断提升，AI基础设施从使用单服务器1卡，发展到使用单服务器8卡，进而发展到使用多服务器8卡的分布式计算环境，在早期的分布式计算中，各节点Node（即服务器）之间的通信是基于Ethernet（以太网）的TCP/IP技术栈实现的
 ...
 ![image-20250220230207614](D:\git_repository\cyber_security_learning\markdown_img\image-20250220230207614.png)

下图展示了基于传统TCP/IP技术栈，节点Node1的应用程序，向节点Node2的应用程序传输数据的过程，具体如下

![image-20250220230354112](D:\git_repository\cyber_security_learning\markdown_img\image-20250220230354112.png)
...
![image-20250220232642824](D:\git_repository\cyber_security_learning\markdown_img\image-20250220232642824.png)
...
![image-20250220233112998](D:\git_repository\cyber_security_learning\markdown_img\image-20250220233112998.png)
...
![image-20250220233800649](D:\git_repository\cyber_security_learning\markdown_img\image-20250220233800649.png)
...
![image-20250220234434835](D:\git_repository\cyber_security_learning\markdown_img\image-20250220234434835.png)
