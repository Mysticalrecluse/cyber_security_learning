...
- 实验：使用hydra或超级弱口令，观察爆破（远程桌面RDP服务）后，查看事件查看器中windows日志的特征
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image66.png)
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image67.png)
    - 导出windows安全日志，利用微软官方工具Log Parser进行分析
      ...
      -o:输出格式
      ```
      ![Alt text](../../../cyber_security_learning/cyber_security/images/image68.png)
...
- <font color=tomato>检查系统账号安全</font>
  ...
  - 结合日志，查看管理员登录时间，用户名是否存在异常（需要额外判断，管理员的密码是否可能爆破成功，若无可能，则这步可以省略）
    ...
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image64.png)
...
- <font color=tomato>查看异常端口、进程</font>
  - 检查网络连接情况，是否有远程连接，可疑连接
    ...
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image69.png)
    - 可以看到建立连接的进程，然后通过`tasklist | findstr 3052`
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image70.png)
    - 可以定位到5555.exe程序这个可疑文件
    - 执行`tasklist /svc | finder 3052` 对这个程序的详细信息进行查看（tasklist /svc，可以打印出进程和服务对应的信息）
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image71.png)
    - 进程无描述，再度可疑
    - 开始--运行--输入`msinfo32`，依次点击“软件环境--正在运行任务”就可以查看到进程详细信息，比如（<font color=tomato>进程路径、进程ID、文件创建日期以及启动时间</font>）
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image72.png)
    - 或者也可以直接用D盾这类安全软件进行扫描
    - 或者用微软官方的Process Explorer工具进行排查
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image73.png)
...
- <font color=tomato>检查启动项、计划任务、服务</font>
  - 检查服务器是否有异常启动项
    ...
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image74.png)
    - 检查方法2：单击“菜单--运行”，输入`msconfig`，查看是否存在命名异常的启动项目，是则取消勾选命名异常启动项目(查看制造商是否异常或为空值，或者直接问管理员)，并到命令中显示的路径中删除文件
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image75.png)
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image76.png)
    ...
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image77.png) 
  ...
  - 检查服务器有没有异常的计划任务
    ...
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image78.png)

  - 检查服务器是否有异常服务
    - 检查方法：在桌面打开运行，输入services.msc，查看服务状态和启动类型，检查是否有异常服务（一般来说，异常服务通常不带描述）
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image79.png)
...
- 账号安全
  ...
  - 检查开机启动项
    ...
    ```
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image80.png)
    - 在对应的文件目录下生成脚本的软连接文件
  
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image81.png)
    - 重启之后就会在tmp文件下生成一个test.txt文件，实验成功
  
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image82.png)
    ...
    ```
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image83.png)
  ...
  - 检查定时任务
    ...
    */1 * * * * echo "hello world" >> /temp/test.txt
    ...
    ```
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image84.png)
  ...
  - 检查系统日志
    ...
    ![Alt text](../../../cyber_security_learning/cyber_security/images/image85.png)
...
- 利用文件属性
  ...
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image88.png)
  - 查看属性隐藏的文件
...
- 真正隐藏文件：
  ...
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image89.png)
  - 隐藏原理：因为windows默认隐藏受保护系统文件，
  - 查看：
    - 组织--文件夹和搜索选项--查看--隐藏受保护系统文件（取消勾选）
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image90.png)
...
- 利用ADS隐藏文件内容
  ...
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image91.png)
  - 查看寄宿文件：
  ```
  dir /r
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image92.png)
  - 删除方法：和宿主文件一起删除
...
```
![Alt text](../../../cyber_security_learning/cyber_security/images/image93.png)

- 克隆账号
  - 第一步：开始--运行--输入regedit后回车，到“HKEY_LOCAL_MACHINE\SAM\SAM”
  - 第二步：右键权限，赋予完全控制权限，然后重启注册表
![Alt text](../../../cyber_security_learning/cyber_security/images/image94.png)
![Alt text](../../../cyber_security_learning/cyber_security/images/image95.png)
![Alt text](../../../cyber_security_learning/cyber_security/images/image96.png)
  - 第三步：将administrator的F的二进制数据，复制到test$用户的配置中
![Alt text](../../../cyber_security_learning/cyber_security/images/image97.png)
  - 切换到$test用户，查看当前用户权限
![Alt text](../../../cyber_security_learning/cyber_security/images/image98.png)
  - 克隆账户成功
...
- 粘滞键后门
  ...
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image101.png)
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image102.png)
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image103.png)
...
- Logon Script后门
  ...
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image104.png)
  - 切换用户，触发后门程序
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image105.png)
...
- 映像劫持
  ...
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image106.png)
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image107.png)
...
- 注册表自启动后门
  ...
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image108.png)
  - 重启后，成功启动后门程序
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image109.png)
  - 方法2：
...
- 计划任务后门
  ...
  schtasks  # 查看计划任务
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image110.png)
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image111.png)
  - 删除计划任务
  ```
  schtasks /delete /tn Updater
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image112.png)
...
- 服务自启动后门（推荐，绑定服务）
  ...
  net start test              #启动服物            
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image113.png)
  - 成功连接后门
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image114.png)
  - 且服务启动过程中，无法删除
...
- SUID Shell
  ...
  chmod u+s /tmp/shell
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image115.png)
  - 使用普通用户权限执行
  ```
  /tmp/shell -p
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image116.png)
  - 排查
  ```
...
- SSH免密登录
  ...
  // 修改这两项配置
  ```
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image117.png)
  - 启动ssh服务
  ```
  ...
  ```
  - 生成的公私钥在root/.ssh/中
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image118.png)
  - 然后安装公钥
  ```
  cat id_rsa.pub >> authorized_keys
  ```
  - 在ssh客户端使用私钥连接
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image119.png)
  - 成功登录
  ![Alt text](../../../cyber_security_learning/cyber_security/images/image120.png)
